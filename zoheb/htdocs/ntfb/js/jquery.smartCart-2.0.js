...
(function($){
    $.fn.smartCart = function(options) {
        ...
        return this.each(function() {
                ...
                var elmPLProducts = $('<div style:"border: 3px solid;"></div>').addClass("scProductList");
    ...
    $.fn.smartCart.defaults = {
          ...
          productItemTemplate:'<strong><%=pname%></strong><br />Category: <%=pcategory%><br /><small><%=pdesc%></small><br /><strong>Quantity: <%=pprice%></strong>',
